...
public class TaulellGrafic extends JFrame {
     ...
     * Constructor
     */
	public TaulellGrafic() throws Exception{
		...
		btnSolucio = new JButton("1 Solucio");
		...
		btnMovimentSeguent = new JButton("Seguent");
		...
		btnAnimacio = new JButton("Animacio");
	...
	public void refreshGui() throws Exception{
	    ...
	    btnDesfer.setEnabled(joc.getHistorial().getMoviments()>0); // Es pot deasctivar el bot� si no hi ha moviments que desfer
